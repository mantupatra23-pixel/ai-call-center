...
# ==========================================
# CALL END (FINAL BILLING) - Fixed Name
# ==========================================
def stop_call_billing(call_sid: str, customer_id: str = None):
    """
    Call end billing:
    - Duration calculate
    - Subscription first
    ...
    data = json.loads(raw)
    customer_id = customer_id or data["customer_id"]
    ...
    if is_subscription_active(customer_id):
        ...
        rate = float(rate_raw) if rate_raw else 2.0
