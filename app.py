...
# CORS CONFIG (Updated for production safety)
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],  # Production mein yahan specific frontend URL dalo
...
from api.subscription_api import router as subscript_router
...
from api.recording_webhook_api import router as record_router
...
# ROUTERS MOUNT
# Dhyan dein: call_router ka prefix humne fix kiya hai
...
app.include_router(subscript_router, prefix="/subscription", tags=["Subscription"])
app.include_router(admin_dashboard_router, prefix="/admin-dashboard", tags=["Admin Dashboard"])

# Webhooks Mount
app.include_router(twilio_router, prefix="/twilio", tags=["Twilio"])
app.include_router(record_router, prefix="/recording", tags=["Recording"])

# Advanced Systems Mount
app.include_router(analytics_router, prefix="/analytics", tags=["Analytics"])
app.include_router(retry_router, prefix="/retry", tags=["Retry"])
app.include_router(dnc_router, prefix="/dnc", tags=["DNC"])
app.include_router(hours_router, prefix="/hours", tags=["Hours"])
